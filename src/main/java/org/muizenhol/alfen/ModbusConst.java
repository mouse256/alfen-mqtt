...
public class ModbusConst {
    ...
    public record Item(String name, int start, int size, DataType type) {
    }
    ...
    public static final Group SOCKET_MEASUREMENT =
            new Group("socket_measurement", 300, 125, List.of(
                    ...
                    new Item("Voltage Phase V(L1-N)", 306, 2, DataType.FLOAT32),
                    new Item("Voltage Phase V(L2-N)", 308, 2, DataType.FLOAT32),
                    new Item("Voltage Phase V(L3-N)", 310, 2, DataType.FLOAT32),
                    ...
                    new Item("Current Phase L1", 320, 2, DataType.FLOAT32),
                    new Item("Current Phase L2", 322, 2, DataType.FLOAT32),
                    new Item("Current Phase L3", 324, 2, DataType.FLOAT32),
                    ...
                    new Item("Frequency", 336, 2, DataType.FLOAT32),
                    ...
                    new Item("Real Power Sum", 344, 2, DataType.FLOAT32),
                    ...
                    new Item("Real Energy Delivered Sum", 374, 4, DataType.FLOAT64),
    ...
    public static final Group STATUS =
            new Group("status", 1200, 16, List.of(
                    ...
                    new Item("Modbus Slave Max Current", 1210, 2, DataType.FLOAT32),
                    ...
                    new Item("Charge using 1 or 3 phases", 1215, 1, DataType.UNSIGNED16)
            ));
